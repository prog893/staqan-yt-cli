 ...
 * @param {string} input - Human-readable name or ISO code (case-insensitive)
 * @returns {string|null} - ISO code (en, ja, ru) or null if invalid
 *
 * @example
 ...
 * @param {string} input - Language to validate
 ...
 * @returns {string|null} - Human-readable name or null
 *
 * @example
 ...
 * @returns {string[]} - Array of ISO codes
 *
 * @example
